...
internal sealed class MeterSnapshotBroadcaster : IMeterSnapshotBroadcaster
{
    ...
    private sealed class Subscription(MeterSnapshotBroadcaster broadcaster, Guid id) : IDisposable
    {
